...
//           label='—'
//           size='small'
//           className='users-rating-chip users-rating-none'
//         />
//       );
//     }
//     const color =
//       rating >= 4.5 ? "#a7f3d0" : rating >= 3.5 ? "#fef3c7" : "#fed7d7";
//     const textColor =
//       rating >= 4.5 ? "#0a6b62" : rating >= 3.5 ? "#975a16" : "#c53030";
//     return (
//       <Chip
...
//             إدارة المستخدمين
//           </Typography>
//           <Typography variant='body2' className='users-subtitle'>
...
//             InputProps={{
//               startAdornment: <SearchIcon className='users-search-icon' />,
//             }}
...
//               <TableHead>
//                 <TableRow>
//                   <TableCell className='users-table-cell-header'>
//                     المستخدم
//                   </TableCell>
//                   <TableCell className='users-table-cell-header'>
//                     معلومات الاتصال
...
//                         )}
//                     </TableCell>
//                     <TableCell className='users-table-cell-city'>
//                       {user.cityName || "-"}
//                     </TableCell>
//                     <TableCell className='users-table-cell-status'>
//                       {getStatusChip(user.tripRating)}
//                     </TableCell>
//                     <TableCell className='users-table-cell'>
//                       {user.joined}
//                     </TableCell>
//                     <TableCell className='users-table-cell-bookings'>
//                       {user.bookings}
//                     </TableCell>
...
//         maxWidth='sm'
//         fullWidth
//         PaperProps={{ className: "users-dialog-paper" }}>
//         <DialogTitle className='users-dialog-title'>
//           {editingItem ? "تعديل" : "إضافة"} مستخدم
//         </DialogTitle>
//         <Formik
...
//                           }}
//                           error={
//                             touched.tripRating && Boolean(errors.tripRating)
//                           }
...
const Users = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await axios.get(
        "http://umrahbooking.runasp.net/api/Dashboard/DashbordUsers/GetUsers",
        {
          headers: {
      ...
      if (err.response?.status === 401) {
        setError("غير مصرح لك بالوصول (401). تأكد من صحة التوكن.");
      } else {
  ...
  const filteredUsers = users.filter(
    (u) =>
      ...
      u.phone?.includes(searchTerm) ||
      u.userCategory?.includes(searchTerm)
  );

  return (
    <Box className='users-container' sx={{ p: 3 }}>
      <Box className='users-header' sx={{ mb: 3 }}>
        <Box className='users-title-group'>
          <Typography
            variant='h4'
          ...
          <Typography
            ...
            color='textSecondary'>
            عرض بيانات المستخدمين المسجلين من الـ API
          </Typography>
        </Box>
      </Box>
                  ...
                  {filteredUsers.length > 0 ? (
                    filteredUsers.map((user) => (
                      <TableRow key={user.id} hover>
                        ...
                        <TableCell>{user.phone || "لا يوجد"}</TableCell>
                        <TableCell>
                          <Typography
                            variant='body2'
